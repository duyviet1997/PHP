                    ...
                    <div class="col-md-6">
                      ...
                      <div class="list-add">
                        <div class="list-img col-md-9">';
                          @for ($i=0; $i < count($img); $i++) <div class="img-prd row col-md-4"><img src="{{asset($img[$i]) }}" alt="a"></div>
                        @endfor
                    ...
                    <div class="tabbable">
                      ...
                      <div class="tab-content">
                        <div class="tab-pane active" id="tab1">
                          ...
                          <p>
                            @if ($star==0)
                            @for ($i = 0; $i < 5; $i++) <i class="icon-star-empty3"></i>
                              @endfor

                              @elseif(round($star,2)< round($star) + 0.25) @for ($i=0; $i < round($star); $i++) <i class="icon-star-full2" style="color: yellow;"></i>
                                @endfor
                                @elseif(round($star,2) >= (round($star) + 0.25) && round($star,2) < (round($star) + 0.75)) @for ($i=0; $i < round($star); $i++) <i class="icon-star-full2" style="color: yellow;"></i>
                                  @endfor
                                  <i class=" icon-star-half" style="color: yellow;"></i>
                                  @else
                                  @for ($i = 0; $i < round($star)+1; $i++) <i class="icon-star-full2" style="color: yellow;"></i>
                                    @endfor
                                    @endif
