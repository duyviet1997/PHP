    ...
    <div class="modal-content" >
      ...
      <div class="modal-body " style="min-height: 480px;height: auto;">
       ...
       <div class="col-md-12 form-group col-md-10" >
        ...
        <a  class="btn btn-primary send_returns ">Trả hàng</a>
        <a type="button" class="btn btn-outline-primary waves-effect" data-dismiss="modal">Hủy</a>
      </div>
      </div>
      </div>
...
<div class="modal fade" id="modal-Cancel" tabindex="-1" role="dialog" >
  <div class="modal-dialog " role="document"  >
    ...
    <div class="modal-content" >
      ...
      <div class="cnt">
      <div class="modal-header">
        <h4 class="title"><i class=" icon-stack-cancel" style="font-size: 17px; margin-right: 5px;"></i> Hủy hàng</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      </div>
      ...
      <div class="modal-body " style="min-height: 280px;height: auto;">
        <div class="form-group col-md-10">
            <label class="">Lý do</label>
            <select name="reason-cancel" required="required" class="select2">
                <option value="Không còn nhu cầu về sản phẩm">Không còn nhu cầu về sản phẩm</option>
                <option value="Đặt trùng sản phẩm" >Đặt trùng sản phẩm</option>
                <option value="Không hài lòng về thời gian giao hàng">Không hài lòng về thời gian giao hàng</option>
                <option value="Tìm được cửa hàng khác">Tìm được cửa hàng khác</option>
                <option value="0">Lý do khác</option>
       ...
       <div class="col-md-12 form-group col-md-10" >
            <div class="add-reason-cancel">
              
            </div>

        </div>
         <div class="col-md-12 text-center">
        <a  class="btn btn-primary" id="sent_cancel_bill">Hủy đơn hàng</a>
        <a type="button" class="btn btn-outline-primary waves-effect" data-dismiss="modal">Hủy</a>
      </div>
      </div>
      </div>
     ...
     <div class="box-content-detail ">
        ...
        @endif
     	...
     	<div class="col-md-4 text-right">
     		<span style=" font-size: 15px;">Tổng cộng: {{number_format($bill->total_bill,0,',','.')}} VNĐ</span>
     	</div>
        </div>
        <div class="main-box">
            <div class="recive-date text-right" style="height: 40px;">
                <div class="col-md-3 text-center">
                    ...
                    <span><a id="returns" data-toggle="modal" data-target="#modal-Cancel" >Hủy đơn hàng</a></span>
                @endif
                </div>
                <div class="col-md-9">
...
<script >
    ...
    <script >
       $(document).on('change','select[name=reason-cancel]',function(){
      if ($('select[name=reason-cancel]').val()=='0') {
          var html='<label >Nội dung</label>' 
             + '<textarea name="content-reason-cancel" class="form-control" required="" rows="2" cols="60" ></textarea>';
          $('.add-reason-cancel').append(html);
      }
      else{
        $('.add-reason-cancel').text('');
      }
    });

        $(document).on('click', '#sent_cancel_bill', function () {
            ...
            swal({
                  ...
                  if (isConfirm) {
                  var reason =$('select[name=reason-cancel]').val();
                  if(reason=='0')
                  {
                    reason= $('textarea[name=content-reason-cancel]').val();
                    if (reason=='') {
                       alert('Bạn hãy nhập lý do!');
                       return false;
