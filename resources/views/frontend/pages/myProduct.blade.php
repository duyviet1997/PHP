...
<hr>
   <div class="thubmnail-recent">
        <img src="{{ asset('/uploads/ao_doi2.jpg') }}" class="recent-thumb" alt="">
    ...
    <div class="thubmnail-recent">
        <img src="{{ asset('/uploads/ao_thun5.jpg') }}" class="recent-thumb" alt="">
    ...
    <div class="thubmnail-recent">
        <img src="{{ asset('/uploads/ao_doi5.jpg') }}" class="recent-thumb" alt="">
