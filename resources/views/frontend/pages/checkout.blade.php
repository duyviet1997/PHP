    ...
    $(document).on('click', 'input[name=apply_coupon]', function () {
        ...
        $.ajax({
            ...
            success: function (html) {
                ...
                if (html=='NotLogin') {
                    swal('Chưa đăng nhập!',"Bạn cần đăng nhập để sử dụng chức năng này!",  "warning");
                }
               if (html=='is_had') {
               ...
               else if(html=='error')
               {
                 ...
                 swal('Lỗi!!!',"Mã bạn nhập chưa đúng hoặc mã hết hạn sử dụng!",  "error");
               }
                else if(html=='email_failse')
               {
                 
                 swal('Lỗi!!!',"Mã bạn nhập không sử dụng cho tài khoản này!",  "error");
               }
                else{
