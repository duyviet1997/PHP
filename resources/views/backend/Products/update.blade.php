                        ...
                        <div class="row">
                            ...
                            @foreach ($color as $colo)
                             ...
                             <div class="form-group col-md-4">
                                ...
                                <div class="group-img-add col-md-10" seti='{{ $i=0 }}'>
                                ...
                                <input type="file" id="cutImg" name="image_list[{{$j}}][{{$i}}]" data-value="{!!is_null(old('image_list[$j][$i]'))?"FashionShop/public/".($img):old('image_list[$j][$i]')!!}" class="file-input-overwrite" data-field="image_list[{{$j}}][{{$i}}]" data-name="{!!is_null(old('image_name[$i]'))?$img:old('image_name[$i]')!!}" data-size="{!!$img!!}">
                                   </div>


                                     <i class="hidden {{$i++}}"></i>
                                @endforeach
                                @for ($k = 0; $k < 3-count($images[$j]); $k++)
                                 <div class="col-md-4">
                                    <input type="file" name="image_list[{{$j}}][{{count($images[$j])+$k}}]" class="file-input-overwrite" data-field="image_list[{{$j}}][{{count($images[$j])+$k}}]">
                                </div>
                                @endfor
                                </div>
                               {{--  <div class="col-md-3">
                        ...
                        <div class="form-group">
                         ...
                         <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input name="import_price" type="number" class="form-control" value="{!!$products->import_price!!}">
...
<script>
  ...
  $(document).on('change', 'input[type=file1]', function () {
   ...
   //        }
    ...
    // {
    //   var str = $("img.file-preview-image").attr('src');
    //   alert(str);
    // });
