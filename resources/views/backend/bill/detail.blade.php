...
@section('content')
  @if (Session::has('success'))
      ...
      <div class="modal-dialog  modal-sm">
        <div class="modal-content" style="   background: blue;bottom: -234px;left: 37px;">
            ...
            <table class="table ">
                <div class="head-talbe">
                    <div class="row">
                     ...
                     @if ($bills->status_order==App\Status_order::STT_SYSTEM_CANCEL || $bills->status_order==App\Status_order::STT_CLIENT_CANCEL )
                           <div><b>Lý do hủy: </b> {{$bills->cancel_reason}} </div>
                        @endif
...
<div class="modal fade right" id="fullHeightModalRight" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="false" padding>
