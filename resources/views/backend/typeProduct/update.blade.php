...
<div class="content">
   @if (Session::has('success'))
    ...
    @endif
    <form action="{{ route('admin.typeproduct.update', $typeproducts->id) }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
        <div class="panel panel-body results">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend class="text-semibold"><i class="icon-reading position-left"></i>Cập nhật loai sản phẩm</legend>
                        <div class="row">
                            <div class="form-group col-md-8">
                                <label class="required">Tên loại sản phẩm</label>
                                <input name="name" type="text" class="form-control" value="{{$typeproducts->name}}">
