...
<div class="modal fade" id="modal-coppy"  role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-side modal-top-right" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Thêm mới loại sản phẩm</h5>
   ...
   <div class="page-header">
   	<div class="page-header-content">
   		<div class="page-title">
                <h4><i class="icon-arrow-left52 position-left"></i> <span class=" text-semibold ">Loại sản phẩm</span></h4>
 ...
 <div class="panel panel-flat">
            <div class="panel-heading">
                ...
                <h5 class="panel-title animated swing">Danh sách loại sản phẩm</h5> 
                 ...
                 @foreach($type as $key=>$value)
                    <tr>
                       ...
                       <th style="text-align: center">
                            ...
                            <a  href="{{ route('admin.typeproduct.edit', $value->id) }}" title="Chỉnh sửa" class="text-success">
                                <i class="icon-pencil"></i>
                            </a>
                           
                            <form action="{{ route('admin.typeproduct.destroy',  $value->id ) }}" method="POST">
                                {!! method_field('DELETE') !!}
                                {!! csrf_field() !!}
