...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function() {
    ...
    Route::get('/report/store/inventory', ['as' => 'admin.report.inventory', 'uses' => 'Backend\ReportController@inventory']);
    ...
    Route::delete('/discount-code/delete/{id}', ['as' => 'admin.discountcode.destroy', 'uses' => 'Backend\DiscountCodeController@destroy']);
     ...
     Route::post('/discount-code/addGroup', ['as' => 'admin.discountcode.addGroupPromocodes', 'uses' => 'Backend\DiscountCodeController@addGroupPromocodes']);
...
Route::get('/updateCart', ['as' => 'updateCart', 'uses' => 'Frontend\CartController@updateCart']);
...
Route::group(['prefix' => 'api'], function() {
  ...
  Route::post('/returns', 'Frontend\HomepageController@returns');
   Route::post('/get_inventory', 'Frontend\HomepageController@get_inventory');
  });
//ajax
